...
public:
	...
	UPROPERTY(BlueprintReadOnly, EditAnywhere, Category="Default", EditFixedSize, meta=(UIMin = "0.0", UIMax = "100.0"), meta=(ReadOnlyKeys))
	...
	UPROPERTY(BlueprintReadOnly, EditAnywhere, Category="Default", EditFixedSize, meta=(ReadOnlyKeys))
